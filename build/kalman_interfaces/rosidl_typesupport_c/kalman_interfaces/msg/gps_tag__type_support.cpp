...
static const _GpsTag_type_support_symbol_names_t _GpsTag_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kalman_interfaces, msg, GpsTag)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kalman_interfaces, msg, GpsTag)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kalman_interfaces, msg, GpsTag)() {
  return &::kalman_interfaces::msg::rosidl_typesupport_c::GpsTag_message_type_support_handle;
}
