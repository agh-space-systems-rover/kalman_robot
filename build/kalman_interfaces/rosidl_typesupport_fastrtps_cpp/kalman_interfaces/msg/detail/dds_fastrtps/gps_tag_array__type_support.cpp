...
#include "kalman_interfaces/msg/detail/gps_tag_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const kalman_interfaces::msg::GpsTag &,
  ...
  size_t current_alignment)
{
  ...
  // Member: tags
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        kalman_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_GpsTag(
  ...
  if (is_plain) {
    ...
    using DataType = kalman_interfaces::msg::GpsTagArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kalman_interfaces::msg::GpsTagArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kalman_interfaces::msg::GpsTagArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GpsTagArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const kalman_interfaces::msg::GpsTagArray *>(
...
static size_t _GpsTagArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GpsTagArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GpsTagArray__callbacks = {
...
static rosidl_message_type_support_t _GpsTagArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GpsTagArray__callbacks,
...
{
  return &kalman_interfaces::msg::typesupport_fastrtps_cpp::_GpsTagArray__handle;
}
