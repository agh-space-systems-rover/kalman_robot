...
#include "kalman_interfaces/srv/detail/set_ueuos_color__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kalman_interfaces::srv::SetUeuosColor_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kalman_interfaces::srv::SetUeuosColor_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kalman_interfaces::srv::SetUeuosColor_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetUeuosColor_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const kalman_interfaces::srv::SetUeuosColor_Request *>(
...
static size_t _SetUeuosColor_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetUeuosColor_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetUeuosColor_Request__callbacks = {
...
static rosidl_message_type_support_t _SetUeuosColor_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetUeuosColor_Request__callbacks,
...
{
  return &kalman_interfaces::srv::typesupport_fastrtps_cpp::_SetUeuosColor_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kalman_interfaces::srv::SetUeuosColor_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kalman_interfaces::srv::SetUeuosColor_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<kalman_interfaces::srv::SetUeuosColor_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetUeuosColor_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const kalman_interfaces::srv::SetUeuosColor_Response *>(
...
static size_t _SetUeuosColor_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetUeuosColor_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetUeuosColor_Response__callbacks = {
  "kalman_interfaces::srv",
...
static rosidl_message_type_support_t _SetUeuosColor_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetUeuosColor_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &kalman_interfaces::srv::typesupport_fastrtps_cpp::_SetUeuosColor_Response__handle;
}
...
static service_type_support_callbacks_t _SetUeuosColor__callbacks = {
  "kalman_interfaces::srv",
  "SetUeuosColor",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kalman_interfaces, srv, SetUeuosColor_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kalman_interfaces, srv, SetUeuosColor_Response)(),
...
static rosidl_service_type_support_t _SetUeuosColor__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetUeuosColor__callbacks,
...
{
  return &kalman_interfaces::srv::typesupport_fastrtps_cpp::_SetUeuosColor__handle;
}
