...
{
  new (message_memory) kalman_interfaces::msg::WheelState(_init);
}

void WheelState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<kalman_interfaces::msg::WheelState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WheelState_message_member_array[2] = {
  {
    ...
    offsetof(kalman_interfaces::msg::WheelState, velocity),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(kalman_interfaces::msg::WheelState, angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WheelState_message_members = {
  ...
  2,  // number of fields
  sizeof(kalman_interfaces::msg::WheelState),
...
{
  return &::kalman_interfaces::msg::rosidl_typesupport_introspection_cpp::WheelState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kalman_interfaces, msg, WheelState)() {
  return &::kalman_interfaces::msg::rosidl_typesupport_introspection_cpp::WheelState_message_type_support_handle;
}
