...
#include "kalman_interfaces/msg/detail/gps_tag__rosidl_typesupport_fastrtps_c.h"
...
using _GpsTag__ros_msg_type = kalman_interfaces__msg__GpsTag;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GpsTag__ros_msg_type * ros_message = static_cast<const _GpsTag__ros_msg_type *>(untyped_ros_message);
  // Field name: tag_id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _GpsTag__ros_msg_type * ros_message = static_cast<_GpsTag__ros_msg_type *>(untyped_ros_message);
  // Field name: tag_id
  {
    cdr >> ros_message->tag_id;
  }
...
static uint32_t _GpsTag__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_kalman_interfaces__msg__GpsTag(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kalman_interfaces__msg__GpsTag;
    is_plain =
      (
      offsetof(DataType, tag_lon) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _GpsTag__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_kalman_interfaces__msg__GpsTag(
...
static message_type_support_callbacks_t __callbacks_GpsTag = {
...
static rosidl_message_type_support_t _GpsTag__type_support = {
