...
#ifndef KALMAN_INTERFACES__SRV__DETAIL__CALIBRATE_COMPASS__FUNCTIONS_H_
#define KALMAN_INTERFACES__SRV__DETAIL__CALIBRATE_COMPASS__FUNCTIONS_H_
...
/// Initialize srv/CalibrateCompass message.
/**
...
/// Finalize srv/CalibrateCompass message.
/**
...
/// Create srv/CalibrateCompass message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * kalman_interfaces__srv__CalibrateCompass_Request__init().
...
/// Destroy srv/CalibrateCompass message.
/**
 * It calls
 * kalman_interfaces__srv__CalibrateCompass_Request__fini()
...
/// Check for srv/CalibrateCompass message equality.
/**
...
/// Copy a srv/CalibrateCompass message.
/**
...
/// Initialize array of srv/CalibrateCompass messages.
/**
...
/// Finalize array of srv/CalibrateCompass messages.
/**
 * It calls
 * kalman_interfaces__srv__CalibrateCompass_Request__fini()
...
/// Create array of srv/CalibrateCompass messages.
/**
 * It allocates the memory for the array and calls
 * kalman_interfaces__srv__CalibrateCompass_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CalibrateCompass messages.
/**
 * It calls
 * kalman_interfaces__srv__CalibrateCompass_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CalibrateCompass message array equality.
/**
...
/// Copy an array of srv/CalibrateCompass messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * kalman_interfaces__srv__CalibrateCompass_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kalman_interfaces
...
/**
 * It calls
 * kalman_interfaces__srv__CalibrateCompass_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_kalman_interfaces
...
/**
 * It allocates the memory for the array and calls
 * kalman_interfaces__srv__CalibrateCompass_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kalman_interfaces
...
/**
 * It calls
 * kalman_interfaces__srv__CalibrateCompass_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // KALMAN_INTERFACES__SRV__DETAIL__CALIBRATE_COMPASS__FUNCTIONS_H_
