...
bool kalman_interfaces__msg__master_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kalman_interfaces.msg._master_message.MasterMessage", full_classname_dest, 51) == 0);
  }
  kalman_interfaces__msg__MasterMessage * ros_message = _ros_message;
  {  // cmd
...
{
  /* NOTE(esteve): Call constructor of MasterMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kalman_interfaces.msg._master_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MasterMessage");
