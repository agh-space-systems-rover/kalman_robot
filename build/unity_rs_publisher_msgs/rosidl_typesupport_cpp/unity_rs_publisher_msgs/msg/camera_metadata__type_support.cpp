...
static const _CameraMetadata_type_support_symbol_names_t _CameraMetadata_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unity_rs_publisher_msgs, msg, CameraMetadata)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unity_rs_publisher_msgs, msg, CameraMetadata)),
  }
};
...
{
  return &::unity_rs_publisher_msgs::msg::rosidl_typesupport_cpp::CameraMetadata_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unity_rs_publisher_msgs, msg, CameraMetadata)() {
  return get_message_type_support_handle<unity_rs_publisher_msgs::msg::CameraMetadata>();
}
