  ...
  private:
	...
	void republish_compressed_msg(
		...
		if (send_) {
			...
			uint8_t data[6] = {
			    convert_twist_data(msg->joint_1),
			    convert_twist_data(msg->joint_2),
			    convert_twist_data(msg->joint_3),
			    convert_twist_data(msg->joint_4),
			    convert_twist_data(msg->joint_5),
			    convert_twist_data(msg->joint_6)
			};
