...
public:
	ArmStateRepublisher() : Node("arm_state_republisher") {
		...
		joint_state_pub_ = this->create_publisher<sensor_msgs::msg::JointState>(
		    "/arm_controllers/joint_states", 10
		);

		arm_state_sub_ =
		    this->create_subscription<kalman_interfaces::msg::ArmState>(
		        "arm_state",
		        10,
		        [this](kalman_interfaces::msg::ArmState::SharedPtr msg) {
			        sub_callback(msg);
		        }
		    );
	}
...
private:
	...
	rclcpp::Subscription<kalman_interfaces::msg::ArmState>::SharedPtr
	                                                           arm_state_sub_;
