            ...
            Node(
                ...
                + (
                    [
                        ...
                        (
                            f"rgbd_image{i}",
                            f"/{realsense_ids[i]}/rgbd_sync/rgbd_image",
                        )
                        for i in range(len(realsense_ids))
                    ]
                    if len(realsense_ids) > 1
                    else [
                        # Just a single topic otherwise
                        ("rgbd_image", f"/{realsense_ids[0]}/rgbd_sync/rgbd_image")
                    ]
                ),
