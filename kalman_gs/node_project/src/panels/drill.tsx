...
export default function Drill() {
  ...
  const autonomyStates = [
    ...
    { label: 'Site 1', value: 1, icon: faPlay, tooltip: 'Set drill autonomy to drilling SITE 1' },
    { label: 'Site 2', value: 2, icon: faPlay, tooltip: 'Set drill autonomy to drilling SITE 2' },
    { label: 'Home', value: 3, icon: faArrowRotateRight, tooltip: 'Set drill autonomy to homing' },
    { label: 'Open "SARKOFAG', value: 4, icon: faArrowRotateRight, tooltip: 'Opening "SARKOFAG"' },
    { label: 'Close "SARKOFAG', value: 5, icon: faArrowRotateRight, tooltip: 'Close "Sarkofag' },
    { label: 'Cleaning', value: 6, icon: faArrowRotateRight, tooltip: 'Cleaning drilling tip' },
  ] as const;
  ...
  const publishAutonomy = (rawValue: number) => {
    const value = normalizeInteger(rawValue, 0, 6, 0);
  ...
  const formatAutonomyState = (value: number | undefined) => {
    ...
    if (value === 1) return 'Drilling Site 1';
    if (value === 2) return 'Drilling Site 2';
    if (value === 3) return 'Homing';
    if (value === 4) return 'Open "SARKOFAG';
    if (value === 5) return 'Close "SARKOFAG';
    if (value === 6) return 'Cleaning'
