# Taken from realsense-ros repo and modified to support composition.
# See: https://github.com/IntelRealSense/realsense-ros/tree/ros2-development/realsense2_camera/launch
